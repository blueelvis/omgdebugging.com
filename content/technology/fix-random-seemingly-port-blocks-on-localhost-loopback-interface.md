...
date: 2021-06-04T09:52:11+00:00
lastmod: 2021-06-04T09:52:56+00:00
...
After running the usual `netstat` commands, I thought that maybe it could be the Windows Firewall which might have some issue and it decided to block those ports. I turned on [Windows Firewall logging](https://www.howtogeek.com/220204/how-to-track-firewall-activity-with-the-windows-firewall-log/) and I didn't see any blockings over there as well. I then turned towards Event Viewer to see if there is any exception which is being generated in the **Administrative Logs**.
...
After searching around for quite a bit, I came across [this Github link](https://github.com/docker/for-win/issues/3171). This talks about the Dynamic Port range reservations which can be used by other services to block ports. I ran `netsh int ipv4 show dynamicport tcp` and the following list popped -
...
**Credit** - [https://github.com/docker/for-win/issues/3171#issuecomment-459205576](https://github.com/docker/for-win/issues/3171#issuecomment-459205576)
